...
{
    /**
     * Inner SVG markup for each icon (primarily <path> elements).
     * Every icon is rendered inside a standard 24×24 wrapper with
  ...
  <circle cx="11" cy="11" r="8" /><line x1="21" x2="16.65" y1="21" y2="16.65" /><line x1="8" x2="14" y1="11" y2="11" />',
    ...
    /** Register or overwrite an icon at runtime. */
    public static function set(string $name, string $paths): void
    {
        self::$icons[$name] = $paths;
    }

    /** Bulk-register icons. */
    public static function merge(array $icons): void
    {
        self::$icons = array_merge(self::$icons, $icons);
    }
}